...
# Define a POST block inside the /baked_goods route
...
# Define a PATCH block inside the /bakeries/<int:id> route
...
# Define a DELETE block inside the /baked_goods/<int:id> route
